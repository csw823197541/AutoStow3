...
public class StowProcess {
    ...
    public void processCwp() {
        ...
        // 检查配载结果是否合理，主要检查槽重，进行调整
        while (!checkAndChangeStowResult(stowMoveList, workingData)) {
            // 2.1 预配位按时间排序
    ...
    private boolean checkAndChangeStowResult(List<StowMove> stowMoveList, WorkingData workingData) {
