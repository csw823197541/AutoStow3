...
public class StowConfig {
    ...
    private String tailBayBelowWeightCntFlag; //尾舱划分轻的情况下，对应这几个舱的甲板下是否划重箱，默认为false
    ...
    public String getTailBayBelowWeightCntFlag() {
        return tailBayBelowWeightCntFlag;
    }

    public void setTailBayBelowWeightCntFlag(String tailBayBelowWeightCntFlag) {
        this.tailBayBelowWeightCntFlag = tailBayBelowWeightCntFlag;
    }
